...
public class Utils {
  ...
  public static byte[] generateContractAddress(Protocol.Transaction lind, byte[] ownerAddress) {
    // get tx hash
  ...
  public static byte[] generateContractAddress(Chain.Transaction lind, byte[] ownerAddress)
      throws InvalidProtocolBufferException {
    return generateContractAddress(Protocol.Transaction.parseFrom(lind.toByteArray()), ownerAddress);
  }
