...
import static org.linda.common.utils.AbiUtil.generateOccupationConstantPrivateKey;
import static org.linda.common.utils.ByteArray.toHexString;
import static org.linda.keystore.StringUtils.byte2String;
import static org.linda.trident.core.Constant.TRANSACTION_DEFAULT_EXPIRATION_TIME;
import static org.linda.trident.core.NodeType.FULL_NODE;
import static org.linda.trident.core.NodeType.SOLIDITY_NODE;
...
import org.linda.trident.api.GrpcAPI;
import org.linda.trident.core.ApiWrapper;
import org.linda.trident.core.NodeType;
...
import org.linda.walletcli.ApiClientFactory;
...
public class ApiClient {
  ...
  public Response.TransactionExtention createAssetIssue(byte[] ownerAddress, String name, String abbrName, long totalSupply, int lindNum, int icoNum, long startTime, long endTime, String url, long freeNetLimit, long publicFreeNetLimit, int precision, HashMap<String, String> frozenSupply, String description) throws IllegalException {// pass
    return client.createAssetIssue(encode58Check(ownerAddress), name, abbrName, totalSupply, lindNum, icoNum, startTime, endTime, url, freeNetLimit, publicFreeNetLimit, precision, frozenSupply, description);
  }
